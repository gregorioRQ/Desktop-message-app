...
public class RabbitMQconfig {
    ...
    @Value("${chat.service.instance.id}")
    ...
    public static final String MESSAGE_DELIVERY_QUEUE = "message.delivery";
    ...
    @Bean
    public Binding messageDeliveryBinding(Queue messageDeliveryQueue, DirectExchange messageExchange) {
        return BindingBuilder.bind(messageDeliveryQueue).to(messageExchange).with("delivery");
    }
